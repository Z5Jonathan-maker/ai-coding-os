...
| Creative direction kernel | Taste is routed as cognitive work, not treated as a generic image task | `cc-creative-kernel-check`, `cc-frontend-wedge-check`, Creative Direction Kernel fixture, taste-driven frontend wedge, design DNA, taste validation | Real project proof bundles from shipped design missions | `cc-creative-kernel-check`, `cc-frontend-wedge-check` | Strong |
