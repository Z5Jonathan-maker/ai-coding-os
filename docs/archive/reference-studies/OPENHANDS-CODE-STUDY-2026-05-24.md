...
`cc-mission-events replay`, lifecycle ordering validation,
`docs/RUNTIME-ADAPTER.md`, and an opt-in `cc-agent-runtime --adapter worktree`
execution boundary. No OpenHands runtime code or Docker-first surface was
imported.
