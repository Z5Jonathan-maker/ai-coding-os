...
*option*to compile the graph once it has been developed for efficiency in prod that’s fine.
...
attentionis the most interesting recent architectural innovation in neural networks.
